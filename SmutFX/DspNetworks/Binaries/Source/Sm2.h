...
template <int NV> struct instance: public Sm2_impl::Sm2_t_<NV>
{
	...
	struct metadata
	{
		...
		SNEX_METADATA_ENCODED_PARAMETERS(2242)
		{
            ...
            0x0000, 0xBF80, 0x0000, 0x3F80, 0xC28F, 0x3F36, 0x0000, 0x3F80, 
            ...
            0x1EB8, 0xBF45, 0x0000, 0x3F80, 0x0000, 0x0000, 0x005C, 0x000C, 
            ...
            0x003F, 0x8000, 0x003F, 0x8000, 0x003F, 0x0000, 0x5C00, 0x0E00, 
            ...
            0x003F, 0x1000, 0x0041, 0x4000, 0x0040, 0x8000, 0x003F, 0x8000, 
            0x5C3F, 0x2400, 0x0000, 0x4600, 0x6C69, 0x6574, 0x4372, 0x7475, 
            0x0032, 0x0000, 0x0000, 0x0000, 0x3F80, 0xD70A, 0x3C23, 0x0000, 
            ...
            0x6570, 0x0000, 0x0000, 0x0000, 0x8000, 0xA43F, 0xBD70, 0x003E, 
            ...
            0x4000, 0x446C, 0x6A72, 0x3E4A, 0xCCCD, 0x3DCC, 0x005C, 0x0041, 
            ...
            0x0000, 0x0000, 0x4000, 0x461C, 0x0000, 0x44B6, 0x6A72, 0x3E4A, 
            ...
            0x7570, 0x0074, 0x0000, 0x0000, 0x0000, 0x3F80, 0x3333, 0x3EB3, 
            ...
            0x4420, 0x6A72, 0x3E4A, 0xCCCD, 0x3DCC, 0x005C, 0x0061, 0x0000, 
            ...
            0xCD3F, 0xCCCC, 0x003E, 0x8000, 0x003F, 0x0000, 0x5C00, 0x6700, 
            ...
            0x736F, 0x0000, 0x0000, 0x0000, 0x8000, 0x0A3F, 0xA3D7, 0x003D, 
	...
	instance()
	{
		...
		this->setParameterT(72, 32.);
		this->setParameterT(73, 1.);
		this->setParameterT(74, 12.);
		...
		this->setParameterT(83, 3.);
		this->setParameterT(84, 2.);
		this->setParameterT(85, 1.);
		this->setParameterT(86, 0.35);
