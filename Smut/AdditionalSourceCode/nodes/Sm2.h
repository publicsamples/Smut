...
template <int NV> struct instance: public Sm2_impl::Sm2_t_<NV>
{
	...
	struct metadata
	{
		...
		SNEX_METADATA_ENCODED_PARAMETERS(2242)
		{
            ...
            0x0000, 0x3F80, 0x0000, 0x4120, 0x0000, 0x40A0, 0x0000, 0x3F80, 
            0x0000, 0x3F80, 0x005C, 0x000D, 0x0000, 0x6946, 0x656C, 0x6E49, 
            0x7570, 0x4774, 0x6961, 0x316E, 0x0000, 0x0000, 0x0000, 0x8000, 
            0xAE3F, 0xE147, 0x003E, 0x8000, 0x003F, 0x0000, 0x5C00, 0x0E00, 
            ...
            0xEC3F, 0x3851, 0x003F, 0x8000, 0x003F, 0x0000, 0x5C00, 0x1800, 
            ...
            0x3264, 0x0000, 0x8000, 0x00BF, 0x8000, 0x003F, 0x8000, 0x003F, 
            ...
            0x0000, 0x8000, 0x003F, 0x8000, 0x183F, 0x8789, 0x003E, 0x0000, 
            ...
            0x4000, 0x461C, 0x0000, 0x4120, 0x6A72, 0x3E4A, 0xCCCD, 0x3DCC, 
            ...
            0x0074, 0x0000, 0x0000, 0x0000, 0x3F80, 0x999A, 0x3E99, 0x0000, 
            ...
            0x461C, 0x6000, 0x448F, 0x6A72, 0x3E4A, 0xCCCD, 0x3DCC, 0x005C, 
            ...
            0x853F, 0x11EB, 0x003F, 0x8000, 0x003F, 0x0000, 0x5C00, 0x6700, 
	...
	instance()
	{
		...
		this->setParameterT(12, 5.);
		this->setParameterT(13, 0.44);
