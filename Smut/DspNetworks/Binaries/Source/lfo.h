...
template <int NV>
using midi2_t = wrap::mod<parameter::plain<math::add<NV>, 0>, 
...
template <int NV> using midi4_t = midi2_t<NV>;
...
template <int NV> struct instance: public lfo_impl::lfo_t_<NV>
{
	...
	instance()
	{
		...
		auto& midi1 = this->getT(1).getT(0).getT(0).getT(0).                                 // lfo_impl::midi1_t<NV>
                      getT(0).getT(0).getT(1).getT(4).
                      getT(0);
		...
		auto& midi2 = this->getT(1).getT(0).getT(0).getT(0).                                 // lfo_impl::midi2_t<NV>
                      getT(0).getT(0).getT(1).getT(5).
                      getT(0);
		...
		auto& chain71 = this->getT(1).getT(0).getT(0).getT(1).                               // lfo_impl::chain71_t<NV>
                        getT(0).getT(0).getT(1).getT(4);
		auto& midi3 = this->getT(1).getT(0).getT(0).getT(1).                                 // lfo_impl::midi3_t<NV>
                      getT(0).getT(0).getT(1).getT(4).
                      getT(0);
		...
		auto& chain72 = this->getT(1).getT(0).getT(0).getT(1).                               // lfo_impl::chain72_t<NV>
                        getT(0).getT(0).getT(1).getT(5);
		auto& midi4 = this->getT(1).getT(0).getT(0).getT(1).                                 // lfo_impl::midi4_t<NV>
                      getT(0).getT(0).getT(1).getT(5).
                      getT(0);
		...
		auto& chain60 = this->getT(1).getT(0).getT(0).getT(2).                               // lfo_impl::chain60_t<NV>
                        getT(0).getT(0).getT(1).getT(4);
		auto& midi6 = this->getT(1).getT(0).getT(0).getT(2).                                 // lfo_impl::midi6_t<NV>
                      getT(0).getT(0).getT(1).getT(4).
                      getT(0);
		...
		midi1.getParameter().connectT(0, add17);                                 // midi1 -> add17::Value
		midi2.getParameter().connectT(0, add18);                                 // midi2 -> add18::Value
		...
		midi3.getParameter().connectT(0, add29);                             // midi3 -> add29::Value
		midi4.getParameter().connectT(0, add30);                             // midi4 -> add30::Value
