...
struct _gran final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow2 = 0.33333334f * float(iSlow1);
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp22 = fTemp10 * ftbl1[iTemp8] + fTemp4 * ftbl1[iTemp5] + fTemp15 * ftbl1[iTemp13] + fTemp20 * ftbl1[iTemp18];
			fVec5[0] = fTemp22;
			fRec25[0] = fConst2 * (0.1f * (fTemp22 - fVec5[1]) + fConst3 * fRec25[1]);
			fRec24[0] = fRec25[0];
