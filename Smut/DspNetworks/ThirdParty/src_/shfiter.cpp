...
struct _shfiter final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp13 = fTemp12 + fTemp5 - fSlow1;
			float fTemp14 = fSlow1 + (fRec0[0] - fTemp12);
			int iTemp15 = std::min<int>(65537, std::max<int>(0, iTemp10 + 1));
			float fTemp16 = 1.0f - fTemp0;
			output0[i0] = FAUSTFLOAT(fTemp0 * (fVec0[(IOTA0 - iTemp3) & 131071] * fTemp6 + fTemp7 * fVec0[(IOTA0 - iTemp8) & 131071]) + (fVec0[(IOTA0 - iTemp11) & 131071] * fTemp13 + fTemp14 * fVec0[(IOTA0 - iTemp15) & 131071]) * fTemp16);
			float fTemp17 = float(input1[i0]);
			fVec1[IOTA0 & 131071] = fTemp17;
			output1[i0] = FAUSTFLOAT(fTemp0 * (fVec1[(IOTA0 - iTemp3) & 131071] * fTemp6 + fTemp7 * fVec1[(IOTA0 - iTemp8) & 131071]) + fTemp16 * (fTemp13 * fVec1[(IOTA0 - iTemp11) & 131071] + fTemp14 * fVec1[(IOTA0 - iTemp15) & 131071]));
			fRec0[1] = fRec0[0];
			IOTA0 = IOTA0 + 1;
		}
	}
