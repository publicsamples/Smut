...
struct _ps2 final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp6 = fTemp4 + fTemp5 - fSlow0;
			float fTemp7 = fSlow0 + (fRec0[0] - fTemp4);
			...
			float fTemp14 = fTemp13 + fTemp5;
			float fTemp15 = fRec0[0] - fTemp13;
			int iTemp16 = std::min<int>(65537, std::max<int>(0, iTemp11 + 1));
			output0[i0] = FAUSTFLOAT((fVec0[(IOTA0 - iTemp3) & 131071] * fTemp6 + fTemp7 * fVec0[(IOTA0 - iTemp8) & 131071]) * fTemp10 + (fVec0[(IOTA0 - iTemp12) & 131071] * fTemp14 + fTemp15 * fVec0[(IOTA0 - iTemp16) & 131071]) * fTemp9);
			float fTemp17 = float(input1[i0]);
			fVec1[IOTA0 & 131071] = fTemp17;
			output1[i0] = FAUSTFLOAT((fVec1[(IOTA0 - iTemp12) & 131071] * fTemp14 + fTemp15 * fVec1[(IOTA0 - iTemp16) & 131071]) * fTemp9 + fTemp10 * (fTemp6 * fVec1[(IOTA0 - iTemp3) & 131071] + fTemp7 * fVec1[(IOTA0 - iTemp8) & 131071]));
			IOTA0 = IOTA0 + 1;
			fRec0[1] = fRec0[0];
		}
	}
