...
struct _gran final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec13[0] = ((iTemp7) ? fSlow6 : fRec13[1]);
			...
			float fTemp22 = ftbl1[iTemp13] * fTemp15 + ftbl1[iTemp8] * fTemp10 + ftbl1[iTemp18] * fTemp20 + fTemp4 * ftbl1[iTemp2];
			fVec5[0] = fTemp22;
