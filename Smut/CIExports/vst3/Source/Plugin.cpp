...
String hise::FrontendHandler::getProjectName() { return "Smut"; };
String hise::FrontendHandler::getCompanyName() { return "modularsamples"; };
String hise::FrontendHandler::getCompanyWebsiteName() { return "http://moddularsamples.com"; };
String hise::FrontendHandler::getCompanyCopyright() { return "(c)2023, modularsamples"; };
