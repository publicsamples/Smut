...
struct Factory: public scriptnode::dll::StaticLibraryHostFactory
{
	Factory()
	{
		...
		registerDataNode<project::chop_networkdata>();
		...
		registerDataNode<project::sawAM_networkdata>();
		registerDataNode<project::shaper_networkdata>();
		registerDataNode<project::ShaperTests_networkdata>();
		registerDataNode<project::SuperDetune_networkdata>();
		registerDataNode<project::sw_networkdata>();
