...
template <int NV> struct instance: public Env_impl::Env_t_<NV>
{
	...
	struct metadata
	{
		...
		SNEX_METADATA_ENCODED_PARAMETERS(176)
		{
            ...
            0x8000, 0x5C3F, 0x0200, 0x0000, 0x4D00, 0x646F, 0x0065, 0x0000, 
            0x8000, 0x003F, 0x4000, 0x0040, 0x0000, 0x0040, 0x8000, 0x003F, 
            0x8000, 0x5C3F, 0x0300, 0x0000, 0x4500, 0x766E, 0x7254, 0x6769, 
            0x0000, 0x0000, 0x0000, 0x0000, 0x3F80, 0x0000, 0x3F80, 0x0000, 
            0x3F80, 0x0000, 0x3F80, 0x005C, 0x0004, 0x0000, 0x0061, 0x0000, 
            0x0000, 0x0000, 0x1C40, 0xCD46, 0x9E7C, 0x7244, 0x4A6A, 0xCD3E, 
            0xCCCC, 0x5C3D, 0x0500, 0x0000, 0x6800, 0x0000, 0x0000, 0x0000, 
            0x4000, 0x461C, 0x0000, 0x0000, 0x6A72, 0x3E4A, 0xCCCD, 0x3DCC, 
            0x005C, 0x0006, 0x0000, 0x0064, 0x0000, 0x0000, 0x0000, 0x1C40, 
            0x0046, 0x0000, 0x7200, 0x4A6A, 0xCD3E, 0xCCCC, 0x5C3D, 0x0700, 
            0x0000, 0x7300, 0x0000, 0x0000, 0x0000, 0x0000, 0x3F80, 0x4D23, 
            0x3F1C, 0x0000, 0x3F80, 0x0000, 0x0000, 0x005C, 0x0008, 0x0000, 
            0x0072, 0x0000, 0x0000, 0x0000, 0x1C40, 0x0046, 0x0000, 0x7200, 
            0x4A6A, 0xCD3E, 0xCCCC, 0x5C3D, 0x0900, 0x0000, 0x4F00, 0x656E, 
            0x6873, 0x746F, 0x0000, 0x0000, 0x0000, 0x0000, 0x3F80, 0x0000, 
            0x0000, 0x0000, 0x3F80, 0x0000, 0x0000, 0x005C, 0x000A, 0x0000, 
            0x6556, 0x6F6C, 0x6963, 0x7974, 0x0000, 0x0000, 0x0000, 0x0000, 
